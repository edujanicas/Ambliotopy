...
class RCScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createScene(){
        ...
        let background = SKSpriteNode(color: UIColor(red: CGFloat(r)/255.0, green: CGFloat(g)/255.0, blue: CGFloat(b)/255.0, alpha: 1.0), size: size)
